...
class OSStatus(UI):
    ...
    def get_yellow_coins(self, skip_first_screenshot=True) -> int:
        ...
        while 1:
            ...
            log_res(self.config).log_res(yellow_coins, 'ViewCurrentResources.ViewCurrentResources.opcoin')
            if timeout.reached():
    ...
    def get_purple_coins(self) -> int:
        ...
        log_res(self.config).log_res(amount, 'ViewCurrentResources.ViewCurrentResources.purplecoin')
        return amount
