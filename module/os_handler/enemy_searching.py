...
from module.os.assets import MAP_GOTO_GLOBE_FOG, MAP_SWITCHING
...
class EnemySearchingHandler(EnemySearchingHandler_):
    def is_in_map(self):
        ...
        if self.match_template_color(MAP_GOTO_GLOBE_FOG, offset=(5, 5)):
            return True
        if self.appear(MAP_SWITCHING, offset=(5, 5)) and MAP_SWITCHING.match_appear_on(self.device.image):
            return True
