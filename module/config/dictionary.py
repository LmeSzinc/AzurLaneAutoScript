...
dic_true_eng_to_eng = {
    ...
    'enable_exp_reward': 'enable_exp_reward',
    ...
    'ammo_pick_up_134': 'ammo_pick_up_134',
...
dic_chi_to_eng = {
    ...
    '喵窝互动': 'do_fort_chores_meowfficer',
    ...
    '启用商店购买': 'enable_shop_buy',
    '军火商过滤字符串': 'shop_general_selection',
    '军火商使用钻石': 'enable_shop_general_gems',
    '启用军火商刷新': 'enable_shop_general_refresh',
    '舰队商店过滤字符串': 'shop_guild_selection',
    '启用舰队商店刷新': 'enable_shop_guild_refresh',
    '舰队商店紫箱': 'shop_guild_box_t3',
    '舰队商店金箱': 'shop_guild_box_t4',
    '舰队商店紫书': 'shop_guild_book_t2',
    '舰队商店金书': 'shop_guild_book_t3',
    '舰队商店紫改造图纸': 'shop_guild_retrofit_t2',
    '舰队商店金改造图纸': 'shop_guild_retrofit_t3',
    '舰队商店蓝强化部件': 'shop_guild_plate_t2',
    '舰队商店紫强化部件': 'shop_guild_plate_t3',
    '舰队商店金强化部件': 'shop_guild_plate_t4',
    '舰队商店一期科研图纸': 'shop_guild_pr1',
    '舰队商店二期科研图纸': 'shop_guild_pr2',
    '舰队商店三期科研图纸': 'shop_guild_pr3',
    '兑换商店过滤字符串': 'shop_medal_selection',
    '军需商店过滤字符串': 'shop_merit_selection',
    '启用军需商店刷新': 'enable_shop_merit_refresh',
    ...
    '拣弹药134': 'ammo_pick_up_134',
    '刷钻石一队': 'gems_fleet_1',
    '刷钻石二队': 'gems_fleet_2',
    '刷钻石关卡': 'gems_stage',
    '自律寻敌刷钻石': 'gems_enable_auto_search',
...
dic_tchi_to_eng = {
    ...
    '喵窩互動': 'do_fort_chores_meowfficer',
    ...
    '啟用商店購買': 'enable_shop_buy',
    '軍火商過濾字符串': 'shop_general_selection',
    '軍火商使用鑽石': 'enable_shop_general_gems',
    '啟用軍火商刷新': 'enable_shop_general_refresh',
    '艦隊商店過濾字符串': 'shop_guild_selection',
    '啟用艦隊商店刷新': 'enable_shop_guild_refresh',
    '艦隊商店紫箱': 'shop_guild_box_t3',
    '艦隊商店金箱': 'shop_guild_box_t4',
    '艦隊商店紫書': 'shop_guild_book_t2',
    '艦隊商店金書': 'shop_guild_book_t3',
    '艦隊商店紫改造圖紙': 'shop_guild_retrofit_t2',
    '艦隊商店金改造圖紙': 'shop_guild_retrofit_t3',
    '艦隊商店藍强化部件': 'shop_guild_plate_t2',
    '艦隊商店紫强化部件': 'shop_guild_plate_t3',
    '艦隊商店金强化部件': 'shop_guild_plate_t4',
    '艦隊商店一期科研圖紙': 'shop_guild_pr1',
    '艦隊商店二期科研圖紙': 'shop_guild_pr2',
    '艦隊商店三期科研圖紙': 'shop_guild_pr3',
    '兌換商店過濾字符串': 'shop_medal_selection',
    '軍需商店過濾字符串': 'shop_merit_selection',
    '啟用軍需商店刷新': 'enable_shop_merit_refresh',
    ...
    '撿彈藥134': 'ammo_pick_up_134',
    '刷鑽石一隊': 'gems_fleet_1',
    '刷鑽石二隊': 'gems_fleet_2',
    '刷鑽石關卡': 'gems_stage',
    '自律尋敵刷鑽石': 'gems_enable_auto_search',
    '啟用紅臉撤退': 'gems_low_emotion_withdraw',
    '更換旗艦裝備': 'gems_flag_ship_equip_change',
    '更換前排裝備': 'gems_vanguard_ship_equip_change',
    '指定旗艦航母': 'common_cv_name',
