...
def main(ini_name=''):
    ...
    reward_tactical.add_argument('--技能書最大稀有度', default=default('--技能書最大稀有度'), choices=['4', '3', '2', '1'], help='最高使用T幾的技能書\nT4---, T3是金書, T2是紫書, T1是藍書\n最大值需要大於等於最小值', gooey_options={'label_color': '#4B5F83'})
    reward_tactical.add_argument('--技能書最小稀有度', default=default('--技能書最小稀有度'), choices=['4', '3', '2', '1'], help='最低使用T幾的技能書\n', gooey_options={'label_color': '#4B5F83'})
    ...
    gems.add_argument('--自律尋敵刷鑽石', default=default('--自律尋敵刷鑽石'), help='這會暫時覆蓋原本的自律尋敵設置', choices=['是', '否'], gooey_options={'label_color': '#4B5F83'})
