...
class GeneratedConfig:
    ...
    Emulator_ScreenshotMethod = (
        "ADB"  # ADB, ADB_nc, uiautomator2, aScreenCap, aScreenCap_nc
    )
    ...
    Emotion_Fleet1Recover = (
        "not_in_dormitory"  # not_in_dormitory, dormitory_floor_1, dormitory_floor_2
    )
    ...
    # Group `EnemyPriority`
    EnemyPriority_EnemyScaleBalanceWeight = (
        "default_mode"  # default_mode, S3_enemy_first, S1_enemy_first
    )
    ...
    # Group `Research`
    Research_UseCube = (
        "only_05_hour"  # always_use, only_05_hour, only_no_project, do_not_use
    )
    Research_UseCoin = (
        "always_use"  # always_use, only_05_hour, only_no_project, do_not_use
    )
    Research_UsePart = (
        "always_use"  # always_use, only_05_hour, only_no_project, do_not_use
    )
    ...
    # Group `Exercise`
    Exercise_OpponentChooseMode = (
        "max_exp"  # max_exp, easiest, leftmost, easiest_else_exp
    )
