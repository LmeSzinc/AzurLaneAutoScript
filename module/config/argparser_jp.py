...
def main(ini_name=''):
    ...
    reward_tactical.add_argument('--tactical_book_tier_max', default=default('--tactical_book_tier_max'),
                                 choices=['4', '3', '2', '1'], help='Which skill book will use first\nT4 is a rainbow book, T3 is a gold book, T2 is a purple book, T1 is a blue book\ntier_max should be greater than or equal to tier_min', gooey_options={'label_color': '#4B5F83'})
    reward_tactical.add_argument('--tactical_book_tier_min', default=default('--tactical_book_tier_min'),
                                 choices=['4', '3', '2', '1'], help='Minimal tier to choose.', gooey_options={'label_color': '#4B5F83'})
    ...
    gems.add_argument('--gems_enable_auto_search', default=default('--gems_enable_auto_search'), help='This temporarily overrides the original auto_search settings', choices=['yes', 'no'], gooey_options={'label_color': '#4B5F83'})
    ...
    os_daily.add_argument('--enable_os_mission_finish', default=default('--enable_os_mission_finish'), gooey_options={'label_color': '#4B5F83'})
