...
def main(ini_name=''):
    ...
    reward_shop_guild.add_argument('--shop_guild_box_t2', default=default('--shop_guild_box_t2'), choices=['eagle', 'royal', 'sakura', 'ironblood'], gooey_options={'label_color': '#4B5F83'})
    ...
    reward_shop_guild.add_argument('--shop_guild_book_t1', default=default('--shop_guild_book_t1'), choices=['red', 'blue', 'yellow'], gooey_options={'label_color': '#4B5F83'})
