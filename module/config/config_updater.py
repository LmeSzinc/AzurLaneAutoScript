...
class ConfigGenerator:
    ...
    def args(self):
        ...
        def check_override(path, value):
            ...
            if type(value) != type(old_value) and path[2] not in [
                "SuccessInterval",
                "FailureInterval",
            ]:
                print(
            ...
            for server in ARCHIVES_PREFIX.keys():
                ...
                def insert(key):
                    ...
                    if name:
                        deep_default(
                            self.args,
                            keys=f"{key}.Campaign.Event.{server}",
                            value=event,
                        )
...
class ConfigUpdater:
    ...
    redirection = [
        ...
        (
            (
                "Alas.DropRecord.SaveMeowfficerTalent",
                "Alas.DropRecord.UploadMeowfficerTalent",
            ),
        ...
        (
            "Alas.DropRecord.SaveMeowfficer",
            "Alas.DropRecord.MeowfficerBuy",
            upload_redirect,
        ),
    ...
    def config_update(self, old, is_template=False):
        ...
        for task in ["WarArchives"]:
            if (
                deep_get(new, keys=f"{task}.Campaign.Event", default="campaign_main")
                == "campaign_main"
            ):
                deep_set(
                    new,
