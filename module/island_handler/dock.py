...
ISLAND_DOCK_SORTING.add_state(
    "Ascending", check_button=ISLAND_DOCK_SORT_ASC, click_button=ISLAND_DOCK_SORTING_CLICK, offset=(20, 5)
)
ISLAND_DOCK_SORTING.add_state(
    "Descending", check_button=ISLAND_DOCK_SORT_DESC, click_button=ISLAND_DOCK_SORTING_CLICK, offset=(20, 5)
)
ISLAND_DOCK_DETECT_AREA = (56, 128, 880, 561)
ISLAND_DOCK_DETECT = Button(
    ISLAND_DOCK_DETECT_AREA, color=(), button=ISLAND_DOCK_DETECT_AREA, name="ISLAND_DOCK_DETECT"
)
...
class IslandDock(IslandUI):
    ...
    def _get_dock_buttons(self):
        area = (
            ISLAND_DOCK_DETECT_AREA[0] + ISLAND_DOCK_CARD_ANCHOR_AREA[0],
