...
class GameSettingsGenerated:
    ...
    autoBotIsAcitve = Field(formatter=int, value=0, regex='autoBotIsAcitve(.*)')

    # /gamecfg/activity/entrancedata.lua
    # PlayerPrefs.GetString("permanent_time", "")
    permanent_time = Field(formatter=str, value='', regex='permanent_time')

    # /mgr/crimgr.lua
    # PlayerPrefs.GetFloat("cv_vol", DEFAULT_CVVOLUME)
    cv_vol = Field(formatter=float, value=0.0, regex='cv_vol')
    # PlayerPrefs.GetFloat("bgm_vol", DEFAULT_BGMVOLUME)
    bgm_vol = Field(formatter=float, value=0.0, regex='bgm_vol')
    # PlayerPrefs.GetFloat("se_vol", DEFAULT_SEVOLUME)
    se_vol = Field(formatter=float, value=0.0, regex='se_vol')

    # /mgr/pushnotificationmgr.lua
    # PlayerPrefs.GetInt("push_setting_" .. slot5.id)
    push_setting = Field(formatter=int, value=0, regex='push_setting_(.*)')
    # PlayerPrefs.GetInt("setting_ship_name")
    setting_ship_name = Field(formatter=int, value=0, regex='setting_ship_name')
    ...
    firstIntoOtherPanel = Field(formatter=float, value=0.0, regex='firstIntoOtherPanel')
    # PlayerPrefs.GetInt("MEMORY_GROUP_NOTIFICATION" .. uv0 .. " " .. slot0, 0)
    MEMORY_GROUP_NOTIFICATION = Field(formatter=int, value=0, regex='MEMORY_GROUP_NOTIFICATION(.*) (.*)')

    # /mgr/tracker/trackermgr.lua
    # PlayerPrefs.GetInt("tracking_" .. slot1, 0)
    tracking = Field(formatter=int, value=0, regex='tracking_(.*)')
    ...
    autoSubIsAcitve = Field(formatter=int, value=0, regex='autoSubIsAcitve(.*)')
    # PlayerPrefs.GetInt(HIDE_CHAT_FLAG)
    pass  # Unknown

    # /mod/battle/data/battledataproxy.lua
    # PlayerPrefs.GetInt("stage_scratch")
    stage_scratch = Field(formatter=int, value=0, regex='stage_scratch')
    ...
    joystick_anchorX = Field(formatter=float, value=0.0, regex='joystick_anchorX')
    # PlayerPrefs.GetFloat("joystick_anchorY", slot1.y)
    joystick_anchorY = Field(formatter=float, value=0.0, regex='joystick_anchorY')
    # PlayerPrefs.GetFloat("joystick_scale", slot1.scale)
    joystick_scale = Field(formatter=float, value=0.0, regex='joystick_scale')
    # PlayerPrefs.GetFloat("auto_scale", slot1.scale)
    auto_scale = Field(formatter=float, value=0.0, regex='auto_scale')
    # PlayerPrefs.GetFloat("auto_anchorX", slot1.x)
    auto_anchorX = Field(formatter=float, value=0.0, regex='auto_anchorX')
    # PlayerPrefs.GetFloat("auto_anchorY", slot1.y)
    auto_anchorY = Field(formatter=float, value=0.0, regex='auto_anchorY')
    ...
    skill = Field(formatter=float, value=0.0, regex='skill_(.*)_scale')
    ...
    world_help_progress = Field(formatter=int, value=0, regex='world_help_progress')

    # /mod/experiment/world/model/worldstaminamanager.lua
    # PlayerPrefs.GetString("world_stamina_reset_tip", "")
    world_stamina_reset_tip = Field(formatter=str, value='', regex='world_stamina_reset_tip')
    # PlayerPrefs.GetString("world_stamina_reset_tip", "")
    pass  # Duplicate
    ...
    world_sub_auto_call = Field(formatter=int, value=0, regex='world_sub_auto_call')
    # PlayerPrefs.GetInt("world_sub_call_line", 0)
    world_sub_call_line = Field(formatter=int, value=0, regex='world_sub_call_line')

    # /mod/experiment/world/view/wscommand.lua
    # PlayerPrefs.GetInt("world_skip_precombat", 0)
    world_skip_precombat = Field(formatter=int, value=0, regex='world_skip_precombat')
    # PlayerPrefs.GetInt(slot0[1], 0)
    pass  # Unknown
    # PlayerPrefs.GetInt("auto_switch_mode", 0)
    auto_switch_mode = Field(formatter=int, value=0, regex='auto_switch_mode')
    # PlayerPrefs.GetString("auto_switch_difficult_safe", "only")
    auto_switch_difficult_safe = Field(formatter=str, value='only', regex='auto_switch_difficult_safe')
    # PlayerPrefs.GetString("auto_switch_difficult_base", "all")
    auto_switch_difficult_base = Field(formatter=str, value='all', regex='auto_switch_difficult_base')
    ...
    chapter_skip_battle = Field(formatter=int, value=0, regex='chapter_skip_battle')

    # /model/proxy/activityproxy.lua
    # PlayerPrefs.GetString("Free_Build_Ticket_" .. slot6.id, "")
    Free_Build_Ticket = Field(formatter=str, value='', regex='Free_Build_Ticket_(.*)')

    # /model/proxy/appreciateproxy.lua
    # PlayerPrefs.GetInt("galleryVersion", 0)
    galleryVersion = Field(formatter=int, value=0, regex='galleryVersion')
    # PlayerPrefs.GetInt("musicVersion", 0)
    musicVersion = Field(formatter=int, value=0, regex='musicVersion')
    # PlayerPrefs.GetInt("mangaVersion", 0)
    mangaVersion = Field(formatter=int, value=0, regex='mangaVersion')
    ...
    chapter_skip_precombat = Field(formatter=int, value=0, regex='chapter_skip_precombat')
    # PlayerPrefs.GetInt(AUTOFIGHT_BATTERY_SAVEMODE, 0)
    pass  # Unknown
    # PlayerPrefs.GetInt(AUTOFIGHT_DOWN_FRAME, 0)
    pass  # Unknown
    ...
    pixelDraw_maxPage = Field(formatter=int, value=0, regex='pixelDraw_maxPage_(.*)_(.*)')

    # /model/proxy/dormproxy.lua
    # PlayerPrefs.GetInt("backyard_template" .. getProxy(PlayerProxy):getRawData().id, 0)
    backyard_template = Field(formatter=int, value=0, regex='backyard_template(.*)')
    # PlayerPrefs.GetInt("backyard_template_help" .. getProxy(PlayerProxy):getRawData().id, 0)
    backyard_template_help = Field(formatter=int, value=0, regex='backyard_template_help(.*)')
    ...
    guild_battle_btn_flag = Field(formatter=int, value=0, regex='guild_battle_btn_flag(.*)')

    # /model/proxy/navalacademyproxy.lua
    # PlayerPrefs.GetString("NavTacticsRecentShipId" .. getProxy(PlayerProxy):getRawData().id)
    NavTacticsRecentShipId = Field(formatter=str, value='', regex='NavTacticsRecentShipId(.*)')
    ...
    server_id = Field(formatter=int, value=0, regex='server.id(.*)')
    # PlayerPrefs.GetString("loginedServer_" .. slot1)
    loginedServer = Field(formatter=str, value='', regex='loginedServer_(.*)')

    # /model/proxy/settingsproxy.lua
    # PlayerPrefs.GetInt("ShipSkinBGM", 1)
    ShipSkinBGM = Field(formatter=int, value=1, regex='ShipSkinBGM')
    # PlayerPrefs.GetInt("disableBG", 1)
    disableBG = Field(formatter=int, value=1, regex='disableBG')
    # PlayerPrefs.GetInt("disableLive2d", 1)
    disableLive2d = Field(formatter=int, value=1, regex='disableLive2d')
    # PlayerPrefs.GetInt("playerShipId")
    playerShipId = Field(formatter=int, value=0, regex='playerShipId')
    # PlayerPrefs.GetString("backyardRemind")
    backyardRemind = Field(formatter=str, value='', regex='backyardRemind')
    # PlayerPrefs.GetInt("userAgreement", 0)
    userAgreement = Field(formatter=int, value=0, regex='userAgreement')
    # PlayerPrefs.GetInt("maxLevelHelp", 0)
    maxLevelHelp = Field(formatter=int, value=0, regex='maxLevelHelp')
    # PlayerPrefs.GetInt("AutoBattleTip", 0)
    AutoBattleTip = Field(formatter=int, value=0, regex='AutoBattleTip')
    # PlayerPrefs.GetInt("setFlagShip", 0)
    setFlagShip = Field(formatter=int, value=0, regex='setFlagShip')
    # PlayerPrefs.GetInt("setFlagShipforskinatlas", 0)
    setFlagShipforskinatlas = Field(formatter=int, value=0, regex='setFlagShipforskinatlas')
    # PlayerPrefs.GetFloat("SetScreenRatio", ADAPT_TARGET)
    SetScreenRatio = Field(formatter=float, value=0.0, regex='SetScreenRatio')
    # PlayerPrefs.GetInt("story_autoplay_flag", 0)
    story_autoplay_flag = Field(formatter=int, value=0, regex='story_autoplay_flag')
    # PlayerPrefs.GetInt("collection_Help", 0)
    collection_Help = Field(formatter=int, value=0, regex='collection_Help')
    # PlayerPrefs.GetInt("main_scene_word_toggle", 1)
    main_scene_word_toggle = Field(formatter=int, value=1, regex='main_scene_word_toggle')
    # PlayerPrefs.GetInt("worldBossFlag" .. slot1, 1)
    worldBossFlag = Field(formatter=int, value=1, regex='worldBossFlag(.*)')
    # PlayerPrefs.GetInt("world_flag_" .. slot1, 0)
    world_flag = Field(formatter=int, value=0, regex='world_flag_(.*)')
    # PlayerPrefs.GetInt("DockYardLockFlag" .. getProxy(PlayerProxy):getRawData().id, 0)
    DockYardLockFlag = Field(formatter=int, value=0, regex='DockYardLockFlag(.*)')
    # PlayerPrefs.GetInt("DockYardLevelFlag" .. getProxy(PlayerProxy):getRawData().id, 0)
    DockYardLevelFlag = Field(formatter=int, value=0, regex='DockYardLevelFlag(.*)')
    # PlayerPrefs.GetFloat(tostring(slot1) .. "_x", 0)
    x = Field(formatter=float, value=0.0, regex='(.*)_x')
    # PlayerPrefs.GetInt(tostring(slot1) .. "_" .. slot2, 1)
    pass  # Unknown
    # PlayerPrefs.GetInt("currentSecretaryIndex", 1)
    currentSecretaryIndex = Field(formatter=int, value=1, regex='currentSecretaryIndex')
    # PlayerPrefs.GetInt("currentSecretaryIndex", 1)
    pass  # Duplicate
    ...
    HitMonsterNianLayer2020 = Field(formatter=str, value='0', regex='HitMonsterNianLayer2020(.*)')
    # PlayerPrefs.GetInt("event_act_help1" .. getProxy(PlayerProxy):getRawData().id, 0)
    event_act_help1 = Field(formatter=int, value=0, regex='event_act_help1(.*)')
    # PlayerPrefs.GetInt("story_speed_flag" .. ((not getProxy(PlayerProxy) or getProxy(PlayerProxy):getRawData().id) and 1), 0)
    story_speed_flag = Field(formatter=int, value=0, regex='story_speed_flag(.*)')
    # PlayerPrefs.GetInt("tipLimitSkinShopTime_", 0)
    tipLimitSkinShopTime = Field(formatter=int, value=0, regex='tipLimitSkinShopTime_')
    # PlayerPrefs.GetString("_WorldBossProgressTipFlag_", slot1[1] .. "&" .. slot1[1] + slot1[2])
    WorldBossProgressTipFlag = Field(formatter=str, value='slot1[1] .. "&" .. slot1[1] + slot1[2]', regex='_WorldBossProgressTipFlag_')
    # PlayerPrefs.GetInt("chat__setting", IndexConst.Flags2Bits(slot1))
    chat__setting = Field(formatter=int, value=0, regex='chat__setting')
    # PlayerPrefs.GetString("commander_play_sortdata", "Rarity#0")
    commander_play_sortdata = Field(formatter=str, value='Rarity#0', regex='commander_play_sortdata')
    # PlayerPrefs.GetInt("ActivityMapSPTip" .. getProxy(PlayerProxy):getRawData().id, 0)
    ActivityMapSPTip = Field(formatter=int, value=0, regex='ActivityMapSPTip(.*)')
    # PlayerPrefs.GetInt(getProxy(PlayerProxy):getRawData().id .. "IsTipNewTheme" .. slot2, 0)
    IsTipNewTheme = Field(formatter=int, value=0, regex='(.*)IsTipNewTheme(.*)')
    # PlayerPrefs.GetString(getProxy(PlayerProxy):getRawData().id .. "IsTipNewGenFurniture")
    IsTipNewGenFurniture = Field(formatter=str, value='', regex='(.*)IsTipNewGenFurniture')

    # /model/proxy/technologyproxy.lua
    # PlayerPrefs.GetInt("technology_version")
    technology_version = Field(formatter=int, value=0, regex='technology_version')

    # /model/proxy/userproxy.lua
    # PlayerPrefs.GetString("user.type")
    user_type = Field(formatter=str, value='', regex='user.type')
    # PlayerPrefs.GetString("user.arg2")
    user_arg2 = Field(formatter=str, value='', regex='user.arg2')
    # PlayerPrefs.GetString("user.arg3")
    user_arg3 = Field(formatter=str, value='', regex='user.arg3')
    # PlayerPrefs.GetString("user.arg1")
    user_arg1 = Field(formatter=str, value='', regex='user.arg1')
    # PlayerPrefs.GetString("transcode")
    transcode = Field(formatter=str, value='', regex='transcode')
    ...
    world_skip_battle = Field(formatter=int, value=0, regex='world_skip_battle')

    # /model/vo/activity.lua
    # PlayerPrefs.GetInt("ACTIVITY_TYPE_EVENT_" .. slot0.id .. "_" .. getProxy(PlayerProxy):getData().id)
    ACTIVITY_TYPE_EVENT = Field(formatter=int, value=0, regex='ACTIVITY_TYPE_EVENT_(.*)_(.*)')

    # /model/vo/chapter.lua
    # PlayerPrefs.GetInt("chapter_quickPlay_flag_" .. slot0.id, 0)
    chapter_quickPlay_flag = Field(formatter=int, value=0, regex='chapter_quickPlay_flag_(.*)')
    ...
    team_formation = Field(formatter=int, value=1, regex='team_formation_(.*)')
    ...
    paint_hide_other_obj = Field(formatter=int, value=0, regex='paint_hide_other_obj_(.*)')
    # PlayerPrefs.GetString("equipment_record" .. "_" .. slot1 .. "_" .. slot0.id)
    equipment_record = Field(formatter=str, value='', regex='equipment_record_(.*)_(.*)')

    # /model/vo/guild/events/guildmission.lua
    # PlayerPrefs.GetInt("guild_mission_formation_tip" .. slot0.configId, 0)
    guild_mission_formation_tip = Field(formatter=int, value=0, regex='guild_mission_formation_tip(.*)')
    ...
    localization_use = Field(formatter=int, value=0, regex='localization_use')
    ...
    BlackWhiteGridMapData = Field(formatter=str, value='', regex='BlackWhiteGridMapData-(.*)-(.*)')
    # PlayerPrefs.GetInt("BlackWhiteGridMapIndex-" .. slot0.player.id, 1)
    BlackWhiteGridMapIndex = Field(formatter=int, value=1, regex='BlackWhiteGridMapIndex-(.*)')
    ...
    DecodeGameHelpBg = Field(formatter=int, value=0, regex='DecodeGameHelpBg(.*)(.*)')
    ...
    FushunAdventureGame = Field(formatter=int, value=0, regex='FushunAdventureGame(.*)')
    ...
    newserver_shop_first = Field(formatter=int, value=0, regex='newserver_shop_first_(.*)')

    # /view/activity/newservercarnival/newservergiftpage.lua
    # PlayerPrefs.GetInt("newserver_gift_first_" .. slot0.playerId)
    newserver_gift_first = Field(formatter=int, value=0, regex='newserver_gift_first_(.*)')
    ...
    SuperBurinPopUp = Field(formatter=int, value=0, regex='SuperBurinPopUp_(.*)')
    ...
    first_crusing_page_display = Field(formatter=int, value=0, regex='first_crusing_page_display:(.*)')
    ...
    jiujiuyoyo_first = Field(formatter=int, value=0, regex='jiujiuyoyo_first_(.*)')

    # /view/activity/subpages/kfcptpage.lua
    # PlayerPrefs.GetInt("kfc_pt_" .. slot0.playerId .. "_day_" .. slot0.curDay)
    kfc_pt = Field(formatter=int, value=0, regex='kfc_pt_(.*)_day_(.*)')
    ...
    PockySkinSignDay = Field(formatter=int, value=0, regex='PockySkinSignDay-1')

    # /view/activity/subpages/wwfptpage.lua
    # PlayerPrefs.GetInt("wwf_first_" .. slot0.playerId)
    wwf_first = Field(formatter=int, value=0, regex='wwf_first_(.*)')
    # PlayerPrefs.GetInt("wwf_select_index_" .. slot0.playerId)
    wwf_select_index = Field(formatter=int, value=0, regex='wwf_select_index_(.*)')
    # PlayerPrefs.GetInt("wwf_select_index_" .. slot0.playerId)
    pass  # Duplicate
    # PlayerPrefs.GetInt("wwf_todo_task_num_" .. slot0.playerId)
    wwf_todo_task_num = Field(formatter=int, value=0, regex='wwf_todo_task_num_(.*)')
    ...
    WorldInPictureScene_1 = Field(formatter=str, value='0#0', regex='WorldInPictureScene_1(.*)')
    ...
    bgFitMode = Field(formatter=int, value=0, regex='bgFitMode')

    # /view/battle/dailylevelscene.lua
    # PlayerPrefs.GetInt("daily_level_quick_battle_tip", 0)
    daily_level_quick_battle_tip = Field(formatter=int, value=0, regex='daily_level_quick_battle_tip')

    # /view/battle/levelmediator2.lua
    # PlayerPrefs.GetInt("chapter_submarine_ai_type_" .. getProxy(PlayerProxy):getRawData().id)
    chapter_submarine_ai_type = Field(formatter=int, value=0, regex='chapter_submarine_ai_type_(.*)')

    # /view/battle/levelscene.lua
    # PlayerPrefs.GetInt("ex_mapId")
    ex_mapId = Field(formatter=int, value=0, regex='ex_mapId')
    # PlayerPrefs.GetString("remaster_tip")
    remaster_tip = Field(formatter=str, value='', regex='remaster_tip')
    # PlayerPrefs.GetInt("chapter_autofight_flag_" .. uv2.id, 1)
    chapter_autofight_flag = Field(formatter=int, value=1, regex='chapter_autofight_flag_(.*)')
    ...
    ShowTransformTip = Field(formatter=int, value=0, regex='ShowTransformTip_(.*)')
    ...
    Ever_Enter_Mall = Field(formatter=int, value=0, regex='Ever_Enter_Mall_')
    # PlayerPrefs.GetInt("Ever_Enter_Skin_Shop_", 0)
    Ever_Enter_Skin_Shop = Field(formatter=int, value=0, regex='Ever_Enter_Skin_Shop_')
    # PlayerPrefs.GetInt("Tec_Ship_Gift_Enter_Tag", 0)
    Tec_Ship_Gift_Enter_Tag = Field(formatter=int, value=0, regex='Tec_Ship_Gift_Enter_Tag')

    # /view/level/levelfleetview.lua
    # PlayerPrefs.GetInt("autoFight_firstUse_sp", 0)
    autoFight_firstUse_sp = Field(formatter=int, value=0, regex='autoFight_firstUse_sp')
    # PlayerPrefs.GetInt(uv0, 1)
    pass  # Unknown
    # PlayerPrefs.GetInt(uv0, 1)
    pass  # Unknown
    # PlayerPrefs.GetInt("lastFleetDuty_" .. (slot0.chapter.id or 0), 0)
    lastFleetDuty = Field(formatter=int, value=0, regex='lastFleetDuty_(.*)')
    # PlayerPrefs.GetInt("SPOPItemReminder")
    SPOPItemReminder = Field(formatter=int, value=0, regex='SPOPItemReminder')
    # PlayerPrefs.GetInt("lastFleetDuty_" .. (slot0.chapter.id or 0), 0)
    pass  # Duplicate
    # PlayerPrefs.GetInt("autoFight_firstUse_sp", 0)
    pass  # Duplicate
    ...
    chapter_loop_flag = Field(formatter=int, value=-1, regex='chapter_loop_flag_(.*)')
    ...
    extraOperationItemID = Field(formatter=int, value=0, regex='extraOperationItemID')
    ...
    fps_limit = Field(formatter=int, value=0, regex='fps_limit')

    # /view/setting/panels/settingsotherpanel.lua
    # PlayerPrefs.GetInt("AUTOFIGHT_BATTERY_SAVEMODE", 0)
    AUTOFIGHT_BATTERY_SAVEMODE = Field(formatter=int, value=0, regex='AUTOFIGHT_BATTERY_SAVEMODE')
    ...
    firstOpenSecondaryPassword = Field(formatter=float, value=0.0, regex='firstOpenSecondaryPassword')

    # /view/setting/panels/settingssoundpanle.lua
    # PlayerPrefs.GetInt("mute_audio", 0)
    mute_audio = Field(formatter=int, value=0, regex='mute_audio')
    # PlayerPrefs.GetFloat("bgm_vol_mute_setting", DEFAULT_BGMVOLUME)
    bgm_vol_mute_setting = Field(formatter=float, value=0.0, regex='bgm_vol_mute_setting')
    # PlayerPrefs.GetFloat("se_vol_mute_setting", DEFAULT_SEVOLUME)
    se_vol_mute_setting = Field(formatter=float, value=0.0, regex='se_vol_mute_setting')
    # PlayerPrefs.GetFloat("cv_vol_mute_setting", DEFAULT_CVVOLUME)
    cv_vol_mute_setting = Field(formatter=float, value=0.0, regex='cv_vol_mute_setting')
    # PlayerPrefs.GetFloat("bgm_vol_mute_setting", DEFAULT_BGMVOLUME)
    pass  # Duplicate
    # PlayerPrefs.GetFloat("se_vol_mute_setting", DEFAULT_SEVOLUME)
    pass  # Duplicate
    ...
    QuickSelectWithoutMaxstar = Field(formatter=str, value='KeepAll', regex='QuickSelectWithoutMaxstar')
    # PlayerPrefs.GetString("QuickSelectWhenHasAtLeastOneMaxstar", "KeepNone")
    QuickSelectWhenHasAtLeastOneMaxstar = Field(formatter=str, value='KeepNone', regex='QuickSelectWhenHasAtLeastOneMaxstar')
    # PlayerPrefs.GetInt("QuickSelectRarity1", 3)
    QuickSelectRarity1 = Field(formatter=int, value=3, regex='QuickSelectRarity1')
    # PlayerPrefs.GetInt("QuickSelectRarity2", 4)
    QuickSelectRarity2 = Field(formatter=int, value=4, regex='QuickSelectRarity2')
    # PlayerPrefs.GetInt("QuickSelectRarity3", 2)
    QuickSelectRarity3 = Field(formatter=int, value=2, regex='QuickSelectRarity3')
    ...
    QUICK_CHANGE_EQUIP = Field(formatter=int, value=1, regex='QUICK_CHANGE_EQUIP')
    ...
    newserver_shop_phase = Field(formatter=int, value=0, regex='newserver_shop_phase_(.*)_(.*)')
    ...
    hadShowForVideoTip = Field(formatter=int, value=0, regex='hadShowForVideoTip')
    # PlayerPrefs.GetInt(SHOW_TOUCH_EFFECT, 1)
    pass  # Unknown

    # /view/snapshot/snapshotsharelayer.lua
    # PlayerPrefs.GetInt("snapshotAgress")
    snapshotAgress = Field(formatter=int, value=0, regex='snapshotAgress')

    # /view/technology/technologysettingslayer.lua
    # PlayerPrefs.GetInt("isShowFinishCatchupVersion")
    isShowFinishCatchupVersion = Field(formatter=int, value=0, regex='isShowFinishCatchupVersion')

    # /view/world/worldscene.lua
    # PlayerPrefs.GetInt("first_auto_fight_mark", 0)
    first_auto_fight_mark = Field(formatter=int, value=0, regex='first_auto_fight_mark')
    # PlayerPrefs.GetInt("world_sub_auto_call", 0)
    pass  # Duplicate
    # PlayerPrefs.GetInt("world_sub_call_line", 0)
    pass  # Duplicate
    ...
    auto_switch_wait = Field(formatter=int, value=0, regex='auto_switch_wait')
    # PlayerPrefs.GetInt("auto_switch_wait_2", 0)
    auto_switch_wait_2 = Field(formatter=int, value=0, regex='auto_switch_wait_2')
    # PlayerPrefs.GetInt("auto_switch_mode", 0)
    pass  # Duplicate
