...
class Equipment(UI):
    ...
    def _equip_view_swipe(self, distance, check_button=EQUIPMENT_OPEN):
        ...
        while 1:
            ...
            if self.appear(check_button, offset=(30, 30)) and not SWIPE_CHECK.match(
                self.device.image
            ):
    ...
    def equip_view_next(self, check_button=EQUIPMENT_OPEN):
        return self._equip_view_swipe(
            distance=-SWIPE_DISTANCE, check_button=check_button
        )
    ...
    def _equip_take_off_one(self):
        ...
        while 1:
            ...
            if (
                ...
                and self.appear_then_click(EQUIP_OFF, offset=10)
            ):
                off_timer.reset()
                continue
    ...
    def _equip_take_on_one(self, index):
        ...
        while 1:
            ...
            if (
                on_timer.reached()
                and self.appear(EQUIP_1, offset=10)
                and not self.info_bar_count()
            ):
                if index == 1:
