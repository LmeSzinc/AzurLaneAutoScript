...
OCR_HARD_REMAIN = Digit(
    OCR_HARD_REMAIN, letter=(123, 227, 66), threshold=128, alphabet="0123"
)
...
class CampaignHard(CampaignRun):
    ...
    def run(self):
        ...
        # Initial
        self.load_campaign(
            name="campaign_hard", folder="campaign_hard"
        )  # Load campaign file
        module = importlib.import_module(
            "." + name, "campaign.campaign_main"
        )  # Load map from normal mode.
