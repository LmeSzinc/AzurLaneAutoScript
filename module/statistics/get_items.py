...
ITEM_GROUP = ItemGrid(
    None, {}, template_area=(40, 21, 89, 70), amount_area=(60, 71, 91, 92)
)
ITEM_GRIDS_1_ODD = ButtonGrid(
    origin=(336, 298), delta=(128, 0), button_shape=(96, 96), grid_shape=(5, 1)
)
ITEM_GRIDS_1_EVEN = ButtonGrid(
    origin=(400, 298), delta=(128, 0), button_shape=(96, 96), grid_shape=(4, 1)
)
ITEM_GRIDS_2 = ButtonGrid(
    origin=(336, 227), delta=(128, 142), button_shape=(96, 96), grid_shape=(5, 2)
)
ITEM_GRIDS_3 = ButtonGrid(
    origin=(336, 223), delta=(128, 149), button_shape=(96, 96), grid_shape=(5, 2)
)
...
class GetItemsStatistics:
    def appear_on(self, image):
        return GET_ITEMS_1.match(image, offset=(20, 20)) or GET_ITEMS_2.match(
            image, offset=(20, 20)
        )
    ...
    def _stats_get_items_load(self, image):
        ...
        if INFO_BAR_1.appear_on(image):
            ...
            ITEM_GROUP.grids = (
                ITEM_GRIDS_1_ODD
                if self._stats_get_items_is_odd(image)
                else ITEM_GRIDS_1_EVEN
            )
