...
DICT_FILTER_PRESET = {
    'series_4_blueprint_tenrai_cube': """
        ...
        > 1.5 > S4-G2.5 > S4-PRY2.5 > 2.5 > S4-DR5 > Q2 > 2 > S4-H4 > S4-DR8
        > S4-PRY5 > Q4 > G4 > 4 > 5 > S4-PRY8 > S4-C6 > 6 > S4-C8 > 8
        > S4-C12 > 12""",
    ...
    'series_4_blueprint_only_cube': """
        ...
        > 1.5 > S4-Q2 > Q2 > 2 > S4-G2.5 > S4-PRY2.5 > 2.5  > S4-Q4 > S4-G4
        > Q4 > G4 > 4 > S4-PRY5 > 5 > S4-PRY8 > S4-C6 > 6 > S4-C8 > 8 > S4-C12 > 12""",
    ...
    'series_4_tenrai_only_cube': """
        ...
        > S4-G4 > S4-G1.5 > Q1 > S4-1 > 1 > reset > S4-DR2.5 > S4-PRY2.5 
        > S4-G2.5 > 1.5 > Q2 > S4-2 > 2 > 2.5 > S4-DR5 > S4-PRY5 > Q4 > G4
        > S4-4 > 4 > 5 > S4-DR8 > S4-PRY8 > S4-C6 > 6 > S4-C8 > 8 > S4-C12 > 12""",
