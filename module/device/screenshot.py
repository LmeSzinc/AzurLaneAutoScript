...
class Screenshot(Adb, WSA, DroidCast, AScreenCap, Scrcpy, NemuIpc, LDOpenGL):
    ...
    def screenshot_methods(self):
        return {
            ...
            'DroidCast_webp': self.screenshot_droidcast_webp,
            'DroidCast_jpeg': self.screenshot_droidcast_jpeg,
            'DroidCast_jpeg_98': self.screenshot_droidcast_jpeg_98,
            'DroidCast_jpeg_96': self.screenshot_droidcast_jpeg_96,
            'DroidCast_raw': self.screenshot_droidcast_raw,
            'DroidCast_lz4': self.screenshot_droidcast_lz4,
