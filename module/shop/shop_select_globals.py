...
SELECT_GRID_4X1 = ButtonGrid(
    origin=(185, 266), delta=(158, 0), button_shape=(119, 19), grid_shape=(4, 1), name="SHOP_SELECT_GRID_4X1"
)

SELECT_GRID_5X1 = ButtonGrid(
    origin=(185, 266), delta=(158, 0), button_shape=(119, 19), grid_shape=(5, 1), name="SHOP_SELECT_GRID_5X1"
)
