...
if server.server != 'jp':
    ...
    OCR_SHOP_GOLD_COINS = Digit(SHOP_GOLD_COINS, letter=(192, 192, 192), name='OCR_SHOP_GOLD_COINS')
    OCR_SHOP_GEMS = Digit(SHOP_GEMS, letter=(205, 192, 82), name='OCR_SHOP_GEMS')
