...
class ShopScroll(Scroll):
    def match_color(self, main):
        ...
        background_mask = (
            background_transparency * np.array(self.color) + (1 - background_transparency) * baseline_color
        )
...
MEDAL_SHOP_SCROLL_250814 = ShopScroll(
    MEDAL_SHOP_SCROLL_AREA_250814.button, color=(44, 48, 56), name="MEDAL_SHOP_SCROLL_250814"
)
