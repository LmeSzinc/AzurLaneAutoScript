...
SHIPYARD_BP_COUNT_GRID = ButtonGrid(
    origin=(324, 688), delta=(181, 0), button_shape=(45, 30), grid_shape=(6, 1), name="SHIPYARD_BP_COUNT_GRID"
)

SHIPYARD_SERIES_GRID = ButtonGrid(
    origin=(75, 133), delta=(399, 91), button_shape=(337, 60), grid_shape=(3, 3), name="SHIPYARD_SERIES_GRID"
)
