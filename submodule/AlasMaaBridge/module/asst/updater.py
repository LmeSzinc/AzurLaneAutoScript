        ...
        for assets in assets_list:
            ...
            assets:
            {
                ...
                "mirrors": [
                  ...
                  "https://ota.maa.plus/MaaAssistantArknights/MaaRelease/releases/download/v5.3.1/MAA-v5.3.1-win-x64.zip"
                ]
            }
            """
            ...
            if match:
                ...
                mirrors.insert(0, github_url.replace("github.com", "ota.maa.plus"))
                # 加上GitHub的release链接
