...
class Config:
    ...
    MAP_ENEMY_TEMPLATE = [
        "LightInvertedOrthant",
        "MainInvertedOrthant",
        "CarrierInvertedOrthant",
    ]
...
class Campaign(CampaignBase):
    ...
    def battle_0(self):
        ...
        if self.clear_enemy(scale=(1,)):
            return True
        if self.clear_enemy(
            scale=(2,), genre=["LightInvertedOrthant", "MainInvertedOrthant"]
        ):
            return True
        if self.clear_enemy(
            scale=(3,), genre=["LightInvertedOrthant", "MainInvertedOrthant"]
        ):
            return True
