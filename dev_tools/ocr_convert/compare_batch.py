...
def main():
    ...
    mod = load_module(
        ...
        15,
        ["data"],
        [("data", (3, 1, hp.img_height, hp.img_width))],
        network=network,
        net_prefix="azur_lane",
        context="cpu",
    )
    ...
    sess = ort.InferenceSession(
        os.path.join(BIN_ROOT, "azur_lane", "azur_lane.onnx"), providers=["CPUExecutionProvider"]
    )
    ...
    print("per-image rows (mx vs onnx):", [prob_mx.shape[0], prob_on.shape[0]])
