...
def main():
    ...
    ocr = Digit(buttons=(0, 0, 200, 40), lang='azur_lane', letter=(255, 255, 255), threshold=128,
                alphabet='0123456789IDSB', name='TEST')
    result = ocr.ocr(img)
    print('Digit result:', result)

    # OcrYuv variant
    from module.ocr.ocr import DigitYuv
    ocr2 = DigitYuv(buttons=(0, 0, 200, 40), lang='azur_lane', letter=(255, 255, 255), threshold=128,
                    alphabet='0123456789IDSB', name='TESTYUV')
    result2 = ocr2.ocr(img)
    print('DigitYuv result:', result2)

    # multi-button Ocr
    ocr3 = Ocr(buttons=[(0, 0, 100, 40), (100, 0, 200, 40)], lang='azur_lane', letter=(255, 255, 255),
               threshold=128, alphabet='0123456789', name='MULTI')
