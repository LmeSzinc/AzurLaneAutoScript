        ...
        for _ in range(2):
            try:
                ...
                gen_path = os.path.join(
                    win32api.GetTempPath(), "gen_py", "%d.%d" % (sys.version_info[0], sys.version_info[1])
                )
                ...
                if os.path.exists(file):
                    ...
                    logger.warning("Cannot find win32com dicts.dat")
                    continue
        try:
            _ = GetObject
        except UnboundLocalError:
            logger.warning(
                "Unable to import win32com.client, please fix it manually, "
