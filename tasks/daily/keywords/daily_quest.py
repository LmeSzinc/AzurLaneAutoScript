...
Enter_combat_by_attacking_enemie_Weakness_and_win_1_times = DailyQuest(
    id=30,
    name='Enter_combat_by_attacking_enemie_Weakness_and_win_1_times',
    cn='利用弱点进入战斗并获胜1次',
    cht='利用弱點進入戰鬥並獲勝1次',
    en="Enter combat by attacking enemies' Weakness and win 1 time(s)",
    jp='弱点を攻撃して戦闘に入り、1回勝利する',
    es='Entra en combate atacando la debilidad del enemigo y gana 1 veces',
)
Use_Technique_1_times = DailyQuest(
    id=31,
    name='Use_Technique_1_times',
    cn='累计施放1次秘技',
    cht='累積施放1次秘技',
    en='Use Technique 1 time(s)',
    jp='累計で秘技を1回発動する',
    es='Usa técnicas 1 veces',
)
Destroy_1_destructible_objects = DailyQuest(
    id=32,
    name='Destroy_1_destructible_objects',
    cn='累计击碎1个可破坏物',
    cht='累積擊碎1個可破壞物',
    en='Destroy 1 destructible object(s)',
    jp='破壊できるオブジェクトを累計で1個破壊する',
    es='Destruye 1 objetos destruibles',
)
...
Consume_1_Trailblaze_Power = DailyQuest(
    id=38,
