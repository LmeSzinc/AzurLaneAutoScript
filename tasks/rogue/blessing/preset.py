BLESSING_PRESET = {
    "Preservation": """
        ...
        > 帝车超光所向捷 > 背生击死 > 背孤击虚 > 拟态：触觉通路 > 宝光烛日月 > 他人即地狱 > 毁灭性吸积 > 乌号綦箭 > 意义质询
        > 丰饶众生，一法界心 > 戒律性闪变 > 大愿般若船 > 飞虹诛凿齿 > 轨道红移 > 甘露 > 完美体验：缄默 > 禳灾 > 线圈编织的罗绮 > 液囊
        > 永坍缩体 > 偏振受体 > 管道交错的桂冠
        > random
        """,
    ...
    "Remembrance": """
        ...
        > 甘露 > 星间构筑•回馈庇护 > 禳灾 > 线圈编织的罗绮 > 液囊 > 永坍缩体 > 偏振受体 > 管道交错的桂冠 > 《冠军晚餐•猫的摇篮》
        > 帝弓断空彻太清 > 云镝逐步离 > 帝车超光所向捷 > 背生击死 > 背孤击虚 > 拟态：触觉通路 > 宝光烛日月 > 他人即地狱 > 毁灭性吸积
        > 乌号綦箭 > 意义质询
        > random
        """,
    ...
    "Nihility": """
        ...
        > reset
        > 胜军 > 天棓步危 > 桑弧蓬矢 > 加持 > 不稳定带 > 孢夹 > 丰饶众生，一法界心 > 戒律性闪变 > 大愿般若船 > 飞虹诛凿齿 > 轨道红移
        > 甘露 > 星间构筑•回馈庇护 > 完美体验：缄默 > 禳灾 > 线圈编织的罗绮 > 液囊 > 永坍缩体 > 偏振受体 > 管道交错的桂冠
        > 《冠军晚餐•猫的摇篮》 > 帝弓断空彻太清 > 云镝逐步离 > 帝车超光所向捷 > 拟态：触觉通路 > 宝光烛日月 > 毁灭性吸积 > 乌号綦箭
        > random
        """,
    ...
    "Abundance": """
        ...
        > 背生击死 > 背孤击虚 > 拟态：触觉通路 > 他人即地狱 > 毁灭性吸积 > 乌号綦箭 > 意义质询 > 戒律性闪变 > 飞虹诛凿齿
        > 星间构筑•回馈庇护 > 完美体验：缄默 > 线圈编织的罗绮 > 液囊 > 永坍缩体 > 偏振受体 > 管道交错的桂冠
        > random
        """,
    ...
    "The_Hunt": """
        ...
        > 完美体验：缄默 > 禳灾 > 线圈编织的罗绮 > 液囊 > 永坍缩体 > 偏振受体 > 管道交错的桂冠 > 火堆外的夜 > 《冠军晚餐•猫的摇篮》
        > 拟态：触觉通路 > 宝光烛日月 > 他人即地狱 > 毁灭性吸积 > 意义质询
        > random
        """,
    ...
    "Destruction": """
        ...
        > 完美体验：缄默 > 禳灾 > 线圈编织的罗绮 > 液囊 > 管道交错的桂冠 > 火堆外的夜 > 《冠军晚餐•猫的摇篮》 > 帝弓断空彻太清
        > 云镝逐步离 > 帝车超光所向捷 > 背生击死 > 背孤击虚 > 拟态：触觉通路 > 宝光烛日月 > 他人即地狱 > 乌号綦箭 > 意义质询
        > random
        """,
    ...
    "Elation": """
        ...
        > 胜军 > 天棓步危 > 桑弧蓬矢 > 加持 > 不稳定带 > 孢夹 > 丰饶众生，一法界心 > 戒律性闪变 > 大愿般若船 > 飞虹诛凿齿 > 轨道红移
        > 甘露 > 星间构筑•回馈庇护 > 完美体验：缄默 > 禳灾 > 线圈编织的罗绮 > 液囊 > 永坍缩体 > 偏振受体 > 管道交错的桂冠
        > 火堆外的夜 > 帝弓断空彻太清 > 云镝逐步离 > 帝车超光所向捷 > 背生击死 > 背孤击虚 > 拟态：触觉通路 > 宝光烛日月 > 他人即地狱
        > 毁灭性吸积 > 乌号綦箭 > 意义质询
        > random
        """,
    ...
    "Propagation": """
        ...
        > 星间构筑•回馈庇护 > 完美体验：缄默 > 禳灾 > 线圈编织的罗绮 > 永坍缩体 > 偏振受体 > 管道交错的桂冠 > 火堆外的夜
        > 《冠军晚餐•猫的摇篮》 > 帝弓断空彻太清 > 云镝逐步离 > 帝车超光所向捷 > 背生击死 > 背孤击虚 > 拟态：触觉通路 > 宝光烛日月
        > 他人即地狱 > 毁灭性吸积 > 乌号綦箭 > 意义质询
        > random
        """,

    "Erudition": """
        景星助狩月 > BCI-34型灰质 > SMR-2型杏仁核 > 模仿：递质合成 > VEP-18型枕叶 > 附加：前庭系统 > 拟态：触觉通路
        > 齿轮啮合的王座 > 湮灭回归不等式 > 分析：阈下知觉 > 装载：纹状皮层 > 激发：跳跃传导 > 植入：外显记忆 > 偏时引燃的炬火
        > 延迟衍射的烛光 > 能量变矩的权杖 > 导线弯绕的指环 > 线圈编织的罗绮 > 金属斑驳的华盖 > 管道交错的桂冠
        > reset
        > 胜军 > 天棓步危 > 桑弧蓬矢 > 加持 > 不稳定带 > 孢夹 > 火堆外的夜 > 《冠军晚餐•猫的摇篮》 > 帝弓断空彻太清 > 云镝逐步离
        > 帝车超光所向捷 > 背生击死 > 背孤击虚 > 宝光烛日月 > 他人即地狱 > 毁灭性吸积 > 乌号綦箭 > 意义质询 > 丰饶众生，一法界心
        > 戒律性闪变 > 大愿般若船 > 飞虹诛凿齿 > 轨道红移 > 甘露 > 星间构筑•回馈庇护 > 完美体验：缄默 > 禳灾 > 液囊 > 永坍缩体
        > 偏振受体
        > random
        """,
