...
KEYWORDS_MAP_PLANE.Jarilo_OldWeaponTestingGround.floors = ['F1', 'F2']
KEYWORDS_MAP_PLANE.Jarilo_PillarsofCreation.page = 'bottom'
KEYWORDS_MAP_PLANE.Jarilo_OldWeaponTestingGround.page = 'bottom'
